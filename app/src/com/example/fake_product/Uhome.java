...
public class Uhome extends Activity {
		...
		scan.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				try {
					...
					Uhome.qrDroidRequired(Uhome.this);
				}
			}
		});
	}	
	protected static void qrDroidRequired(final Uhome uhome) {
		// TODO Auto-generated method stub
		
AlertDialog.Builder AlertBox = new AlertDialog.Builder(uhome);
		...
		AlertBox.setPositiveButton("Direct Download", new OnClickListener() {
			...
			public void onClick(DialogInterface arg0, int arg1) {
				...
				uhome.startActivity(new Intent(Intent.ACTION_VIEW, 
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if( ACTIVITY_RESULT_QR_DRDROID == requestCode 
			...
			Intent in=new Intent(getApplicationContext(),Verfication.class);
