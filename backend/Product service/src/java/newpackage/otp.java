...
public class otp extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String otp1=request.getParameter("votp");
		...
		ResultSet rs = st.executeQuery("select * from manufacturer where otp='"+otp1+"'");
            if(rs.next())
            {
            ...
            {
                out.print("<script>alert('Hello enter correct otp') </script>");
                request.getRequestDispatcher("otperror.jsp").include(request, response);        
                out.print("<br><br><br><h1><center>Sorry OTP error!"+"</h1>");
            }
